...
\addcontentsline{toc}{chapter}{Basit Geliştirme Ortamı (Editör + Derleyici)}

\hypertarget{auxe7ux131klama}{%
\section*{Açıklama}\label{auxe7ux131klama}}
\addcontentsline{toc}{section}{Açıklama}
...
\begin{Shaded}
\begin{Highlighting}[]
   \KeywordTok{set} \BuiltInTok{:}\NormalTok{ versiyon atama}
...
\addcontentsline{toc}{chapter}{GNU Autotools}
...
\addcontentsline{toc}{subsection}{A. C++ Projesi ve Gerekli Dosyalar}
...
\addcontentsline{toc}{subsection}{B. ``Makefile.am'' dosyası}
...
\addcontentsline{toc}{subsection}{C. ``configure.ac'' dosyası}
...
\addcontentsline{toc}{section}{Conan Bölüm içeriği}
...
\addcontentsline{toc}{chapter}{Docker}
