# 4 GNU Autotools İnşa etme Sistemi:
...
<code>$ sudo dnf install autoconf automake</code>
...
## 4.3 Örnek: Temel GNU autotools projesi

### 4.3.1 Proje Dosyaları
...
Çalıştır: <code>$ make install</code>
...
Çalıştır: <code>$ make dist</code> => Bir tarball dağılımı oluşturun.
...
## 4.4 İleri düzey için tavsiye kaynaklar
